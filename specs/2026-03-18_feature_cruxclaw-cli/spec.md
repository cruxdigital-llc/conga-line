...
variable "users" {
  ...
  default = {
    UA13HEGTS = {
      ...
      gateway_port  = 18789
      iam_identity  = "aaron@cruxdigital.com"  # placeholder — replace with actual
    }
    U01UNLBCWNR = {
      slack_channel = "C0ALU1AG6ES"
      gateway_port  = 18790
      iam_identity  = "user2@cruxdigital.com"  # placeholder — replace with actual
    }
  }
...
type ResolvedIdentity struct {
    IAMArn      string  // e.g., arn:aws:sts::167595588574:assumed-role/OpenClawUser/aaron@cruxdigital.com
    AccountID   string
    UserID      string
    SessionName string  // e.g., aaron@cruxdigital.com (extracted from ARN)
    MemberID    string  // e.g., UA13HEGTS (from SSM Parameter lookup)
}
...
UA13HEGTS     C0ALL272SV8     18789
U01UNLBCWNR   C0ALU1AG6ES     18790
```
